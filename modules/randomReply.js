...
let randomReply = {
    ...
    preparedReplies: {
        ...
        answer: [
            ...
            "おｋ", "惜しいっ", "… :rolling_eyes: ", "なんて？", "どんなの？", "それはだめ", "ですよね？", "知らない～", "そんなのきいちゃうの…", "えぇ…", "拒否します",
            ":hear_no_evil:", "お菓子くれたら教える", "見返りは？", "こっそりなら言えるけど公ではちょっと…"
        ]
    },
    ...
    backupJson: () => {
        ...
        return util.backupJson(randomReply.database, fileName, dataFile, aws_config)
    },
